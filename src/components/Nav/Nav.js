...
import Logo from 'public/assets/pikke-logo-white';
...
const Nav = () => {
  ...
  // here we can choose which menu we want using the location
  // we've overwritten the below data and just used 'MAIN'
  ...
  // this will show you the menus that are available and what the locations are
  // for the menu you want, go to lib/menus.js and set the location
  // eg MENU_LOCATION_NAVIGATION_DEFAULT = 'PRIMARY';
  ...
  return (
    <nav className={styles.nav}>
      <Section className={styles.navSection}>
        ...
        <Link className={styles.buildYourBrief} href="/build-your-brief">
          Build your brief
        </Link>
      </Section>
    </nav>
